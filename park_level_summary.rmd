...
plotTrend(park = parkcode, site = stream_list, years = yr_start:yr_current, parameter = "Discharge_cfs", 
          gridlines = "grid_x", months = 5:10)
cat(paste0("<p style='width:1280px;'>Trends in monthly discharge for 2013", yr_start, " to ", yr_current, 
    " in ", plot_sname, "</p>"))
```
<br>
...
plotClimTrend(park = parkcode, years = yr_start:yr_current, parameter = 'ppt', 
              palette = c("Set2"), months = 5:10, layers = 'bar', gridlines = "grid_x")
cat(paste0(
  "<p style='width:1280px;'>",
...
cat(paste0(
  ...
  'Trends in water level for ', plot_lname, 
   ' from 2013 to ', yr_current, ' for each month. Points represent monthly sample measurements.", 
...
plotClimTrend(park = parkcode, years = 2013:yr_current, parameter = 'ppt', palette = c("Set2"), 
              months = 5:10, layers = 'bar', gridlines = "grid_x")
cat(paste0(
  "<p style='width:1280px;'>",
...
drgt_cap5 <- paste0("<p style = 'width:1280px;'>Figure shows last 5 years (", yr5, ":", yr_current, ") of weekly drought condition based on proportion of a park's predominant county by drought level using the <a href='https://droughtmonitor.unl.edu/'>U.S. Drought Monitor</a>.</p>") 

temp_capT <- paste0("<p style = 'width:1280px;'>Figure shows loess smoothed (span 0.3) minimum, maximum, and average temperature trends from 1900 to ", yr_current, " by month derived from <a href='https://www.ncei.noaa.gov/access/metadata/landing-page/bin/iso?id=gov.noaa.ncdc:C00332'>NOAA NClimGrid </a> gridded climate dataset extracted for a given park's geographic centroid.</p>")
...
drgt_capT <- paste0("<p style = 'width:1280px;'>Figure shows long-term trends (2000:", yr_current, ") in weekly drought condition based on proportion of a park's predominant county by drought level using the <a href='https://droughtmonitor.unl.edu/'>U.S. Drought Monitor</a>. Note that drought data are only available from 2000 to present.</p>") 
...
ppt_comp <- plotClimComps(park = park,years= yr_current, palette = 'blue', parameter = c('ppt'),
                           legend_position = "bottom", plot_title = F)
ppt_anom <- plotClimAnom(park = parkcode, years = yr_current, parameter = 'ppt',
                          legend_position = "bottom")
...
yr1 = yr_current - 4
plotClimAnom(park = parkcode, years = yr1:yr_current, parameter = 'tmean', legend_position = "bottom", gridlines = "grid_x")
cat(anom_cap5, "\n\n")
```
</details>
<br>
...
```{r fig.height=8, fig.width=13, results = 'asis'}
plotClimAnom(park = parkcode, years = yr1:yr_current, parameter = 'ppt', legend_position = "bottom", gridlines = "grid_x")
cat(anom_cap5, "\n\n")
```
</details>
<br>
...
plotClimTrend(park = parkcode, years = 1900:yr_current, 
              ...
              layers = "smooth", gridlines = "grid_x")
cat(temp_capT, "\n\n")
