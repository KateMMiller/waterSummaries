...
plotTrend(park = parkcode, site = lake_list, months = 5:10,
          ...
          legend_position = 'right', threshold = FALSE)
...
```
<br>
```{r warning = F, message = FALSE, eval = eval_lake, results = 'asis', fig.height=3, fig.width=12.8}
plotClimTrend(park = parkcode, years = 2013:yr_current, parameter = 'ppt', palette = c("blue"), 
