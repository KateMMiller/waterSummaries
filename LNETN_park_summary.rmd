...
cat("<details open><summary class = 'drop'>Field Measurements</summary>", "\n\n")
pf <- plotTrend(park = parkcode, years = yr_start:yr_current, parameter = sonde_params, 
          smooth = T, span = 0.9, legend_position = "bottom", threshold = F, numcol = 2)
ggplotly(pf, tooltip = 'text') |> layout(legend = list(orientation = "h", x = 0, xanchor = "left", yanchor = "bottom"))

cat(paste0("<p style='width:1280px;'>Trends in field water quality parameters for ", park_name, " from ",
           yr_start, " to ", yr_current, 
           ". Points represent monthly sample measurements. Hovering over the points will provide more information. Clicking on sites in the legend will turn them on/off in the figure.", 
           " Lines represent loess smoothed trends with span 0.9.</p></details>\n\n"))

cat("\n\n")

cat("<details open><summary class = 'drop'>Lab Chemistry</summary>", "\n\n")
pl <- plotTrend(park = parkcode, years = yr_start:yr_current, parameter = chem_params, 
          smooth = T, span = 0.9, legend_position = "bottom", threshold = F, numcol = 2)
ggplotly(pl, tooltip = 'text') |> layout(legend = list(orientation = "h", x = 0, xanchor = "left", yanchor = "bottom"))

cat(paste0("<p style='width:1280px;'>Trends in lab chemistry water quality parameters for ", park_name, " from ",
           yr_start, " to ", yr_current, 
           ". Points represent monthly sample measurements. Hovering over the points will provide more information. Clicking on sites in the legend will turn them on/off in the figure.", 
           " Lines represent loess smoothed trends with span 0.9.</p></details>\n\n"))
```
...
plotTrend(park = parkcode, site = stream_list, years = yr_start:yr_current, parameter = "Discharge_cfs", 
          gridlines = "grid_x", months = 5:10, legend_position = "bottom")
...
plotClimBar(park = parkcode, years = yr_start:yr_current, parameter = 'ppt', 
            months = 5:10, gridlines = "grid_x", units = "eng", palette = "#1378b5")
cat(paste0(
  "<p style='width:1280px;'>",
...
plotClimBar(park = parkcode, years = 2013:yr_current, parameter = 'ppt',
              months = 5:10, gridlines = "grid_x", units = "eng", palette = "#1378b5")
cat(paste0(
  "<p style='width:1280px;'>",
